...
export const HomeIcons = () => {
  return (
    <div className='z-1 grid grid-cols-3 grid-row-2 justify-items-center items-center'>
        ...
        <div className="z-1 col-start-1 col-span-1 row-span-1 row-start-2"><ReadingIcon></ReadingIcon></div>
        <div className="z-1 col-start-3 col-span-1 row-span-1 row-start-2 "><HistoryIcon></HistoryIcon></div>
    </div>
  )
}
